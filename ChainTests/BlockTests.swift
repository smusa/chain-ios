...
class BlockTests : BaseTests {
    ...
    func testBlockHeaderByHeight() {
        ...
        self.client.getBlock(0) { block, error in

            XCTAssert(block != nil)
            XCTAssertEqual(block.height, 0)
            XCTAssertEqual(block.blockID, "000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f")

            let txids = block.transactionIDs as [String]
    ...
    func testBlockHeaderByHeight2() {
        self.shouldCompleteIn(10.0)
        self.client.getBlock(100000) { block, error in
    ...
    func testBlockHeaderByHash() {
        self.shouldCompleteIn(10.0)
        self.client.getBlock("000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f") { block, error in
